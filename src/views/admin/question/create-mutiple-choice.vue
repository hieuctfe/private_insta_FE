                            ...
                            <div class="row">
                                ...
                                <div class="col col-6">
                                    ...
                                    <div class="row m-b-10 row-test-case" v-for="(item, index) in form.test_case" :key="`test_case_index${index}`">
                                        ...
                                        <div class="col col-1 p-t-5">
                                            <a  @click.stop.prevent="removeTestCase(index)" :disabled="setDisabledRemove">
...
export default {
    ...
    async created(){
        for (let index = 0; index < parseInt(process.env.VUE_APP_MIN_ANSWER_CHOICE_QUESTION) ; index++) {
