                    ...
                    <form class="card" @submit.stop.prevent="onSubmit()" novalidate>
                        <div class="card-body">
                            <div class="row m-b-20">
                                <div class="col col-6">
                                    <div class="page-title">Create Code Question</div>
                                </div>
                                <div class="col col-6">
                            ...
                            <div class="row">
                                <div class="col col-6">
                                    ...
                                    <div class="form-group">
                                        <label>Threads</label>
                                        <markdown-editor v-model.trim="form.threads"  :height-auto="true"></markdown-editor>
                                        <transition name="fade" mode="out-in">
                                    ...
                                    <div class="form-group">
                                        <checkbox v-model="form.is_hit" label="Show hint"></checkbox>
                                    </div>
...
export default {
        ...
        onSubmit(){
            ...
            if( !this.is_sending && !this.$v.form.$invalid && this.isTestCaseValid){
                this.$refs.confirm.show({
                    title : 'Confirm',
                    content : 'Do you want to create this question ?',
                    btnSave : 'Create Question',
                    onSave : () => {
                        return new Promise((resolve , reject) =>{
                            this.postCreateQuestion().finally((res)=>{
                                resolve()
                            })
                        })
                    }
        ...
        postCreateQuestion(){
            return new Promise((resolve, reject)=>{
                ...
                var formdata = {
                    ...
                    auto_generate_testcase : this.form.is_auto_general_test_case ? this.form.auto_generate_testcase : '',
                    test_case : this.form.test_case
                }
                this.createQuestion(formdata).then(res=>{
    ...
    async created(){
        for (let index = 0; index < this.min_test_case ; index++) {
