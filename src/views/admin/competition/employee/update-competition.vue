                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col col-6">
                                        <div class="row">
                                            ...
                                            <div class="col col-12">
                                                <div class="form-group">
                                                    <label>Date </label>
                                                    <datepicker class="vue-datepicker" :starting-date-value="form.date.start_date"  :ending-date-value="form.date.end_date" v-model="form.date" ></datepicker>
                                                    <transition name="fade" mode="out-in">
                                    ...
                                    <div class="col col-6">
                                        ...
                                        <file-picker v-model="form.image" :current.sync="form.current_image" :extensions="['jpg', 'png', 'jpe', 'jpeg']"></file-picker>
                                        <transition name="fade" mode="out-in">
...
export default {
            ...
            form : {
                ...
                image:{
                    required: requiredIf( (nested)=>{
                        return this.form.current_image == null 
                    })
                },
                users: {
                    required
    ...
    created(){
        ...
        this.form = {
            ...
            date: {
                start_date :  moment(this.data.start_date, "YYYY-MM-DD").toDate(),
                end_date : moment(this.data.end_date, "YYYY-MM-DD").toDate(),
            },
            image: '',
            current_image : {
                src : this.data.image,
                type: this.data.image.replace(/^.*\./, '').toLowerCase(),
            },
